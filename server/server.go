...
import (
	...
	// "github.com/coderun-top/coderun/server/logging"
	// "github.com/coderun-top/coderun/server/pipeline/pipeline/rpc/proto"
	// "github.com/coderun-top/coderun/server/pubsub"
	// grpc_retry "github.com/grpc-ecosystem/go-grpc-middleware/retry"
	// "github.com/coderun-top/coderun/server/plugins/sender"
	// "github.com/coderun-top/coderun/server/remote"
	"github.com/coderun-top/coderun/server/router"
	// "github.com/coderun-top/coderun/server/router/middleware"
	// droneserver "github.com/coderun-top/coderun/server/server"
...
const (
	...
	// GRPCClientKeepaliveTime 表示从没有活动开始发送PING的间隔。
	GRPCClientKeepaliveTime = 5 * time.Second
	// GRPCClientKeepaliveTimeout 表示等待PING响应的时间
...
func server(c *cli.Context) error {
	...
	grpc_client := pb.NewGreeterClient(conn)
	setupEvilGlobals(c, store_, remote_, grpc_client)
...
func setupEvilGlobals(c *cli.Context, v store.Store, r remote.Remote, p pb.GreeterClient) {
	...
	// services
	droneserver.Config.Services.Grpc = p
