...
import (
	...
	"github.com/coderun-top/coderun/src/core/pipeline/pipeline"
	"github.com/coderun-top/coderun/src/core/pipeline/pipeline/backend"
	"github.com/coderun-top/coderun/src/core/pipeline/pipeline/backend/docker"
	"github.com/coderun-top/coderun/src/core/pipeline/pipeline/multipart"
...
func (r *runner) run(ctx context.Context) error {
	...
	defaultTracer := pipeline.TraceFunc(func(state *pipeline.State) error {
		...
		state.Pipeline.Step.Environment["CI_MACHINE"] = r.name
		state.Pipeline.Step.Environment["CI_BUILD_STATUS"] = "success"
		state.Pipeline.Step.Environment["CI_BUILD_STARTED"] = strconv.FormatInt(state.Pipeline.Time, 10)
		state.Pipeline.Step.Environment["CI_BUILD_FINISHED"] = strconv.FormatInt(time.Now().Unix(), 10)
		state.Pipeline.Step.Environment["DRONE_MACHINE"] = r.name
