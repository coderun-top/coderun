...
func (c *Client) GetWebhooks(globalKey, projectName string, t int) ([]*Webhook, error) {
...
func (c *Client) AddWebhook(globalKey, projectName, link string, t int) error {
	webhooks, err := c.GetWebhooks(globalKey, projectName, t)
	if err != nil {
		return err
	}
...
func (c *Client) RemoveWebhook(globalKey, projectName, link string, t int) error {
	webhooks, err := c.GetWebhooks(globalKey, projectName, t)
	if err != nil {
		return err
	}
