...
func (g *Client) AllGroups(t int) ([]*Namespace, error) {
	var perPage = 100
	var groups []*Namespace

	for i := 1; true; i++ {
		contents, err := g.Groups(i, perPage, t)
		if err != nil {
			return groups, err
		}
...
func (g *Client) Groups(page, perPage, t int) ([]*Namespace, error) {
	...
	contents, err := g.Do("GET", url, opaque, nil, t)
	if err == nil {
