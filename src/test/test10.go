...
func ParseRequest(fn SecretFunc) (*Token, error) {
	token := "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0ZXh0IjoiMTIzIiwidHlwZSI6Imhvb2sifQ.JJaFvtFeddDQjZsUkQefO-uxax45P7QbZyqC7gNDaLI"
...
func main() {
	fmt.Println("123123")
	hash := "YBGTUOSD3CFUJ4I4JUDHYTBJ3RDEVDOEYWNMSPZDBCPRSTWJGUKA===="
	t := New("hook", "123")
	...
	parsed, _ := ParseRequest(func(t *Token) (string, error) {
		return hash, nil
	})
